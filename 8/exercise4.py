...
# and read it line by line. For each line,
# split the line into a list of words using
# the split function. For each word, check to
# see if the word is already in a list. If the
...
with open("romeo.txt", "r") as file_ptr:
    vocab = []
